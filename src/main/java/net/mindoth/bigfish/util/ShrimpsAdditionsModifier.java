...
public class ShrimpsAdditionsModifier extends LootModifier {
    ...
    protected ShrimpsAdditionsModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<ShrimpsAdditionsModifier> {

        @Override
        public ShrimpsAdditionsModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
            Item addedItem = ForgeRegistries.ITEMS.getValue(
                    new ResourceLocation((GsonHelper.getAsString(object, "item"))));
            return new ShrimpsAdditionsModifier(conditionsIn, addedItem);
        }

        @Override
        public JsonObject write(ShrimpsAdditionsModifier instance) {
