...
public class SlimyEelAdditionModifier extends LootModifier {
    ...
    protected SlimyEelAdditionModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<SlimyEelAdditionModifier> {
        ...
        @Override
        public SlimyEelAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
