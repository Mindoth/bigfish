...
public class AnglerfishAdditionModifier extends LootModifier {
    ...
    protected AnglerfishAdditionModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<AnglerfishAdditionModifier> {
        ...
        @Override
        public AnglerfishAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
