...
public class MonkfishAdditionModifier extends LootModifier {
    ...
    protected MonkfishAdditionModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<MonkfishAdditionModifier> {
        ...
        @Override
        public MonkfishAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
