...
public class LobsterAdditionModifier extends LootModifier {
    ...
    protected LobsterAdditionModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<LobsterAdditionModifier> {
        ...
        @Override
        public LobsterAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
