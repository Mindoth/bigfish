...
public class MantarayAdditionModifier extends LootModifier {
    ...
    protected MantarayAdditionModifier(LootItemCondition[] conditionsIn, Item addeditemIn) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<MantarayAdditionModifier> {
        ...
        @Override
        public MantarayAdditionModifier read(ResourceLocation location, JsonObject object, LootItemCondition[] conditionsIn) {
