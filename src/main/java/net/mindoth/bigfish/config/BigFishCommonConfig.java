...
public class BigFishCommonConfig {
    ...
    static {
        ...
        DARKCRAB_CHANCE = BUILDER.comment("The chance of fishing up a Dark crab Default = 0.2 = 20%")
                .defineInRange("Dark crab chance", 0.1, 0.0, 1.0);

        LOBSTER_CHANCE = BUILDER.comment("The chance of fishing up a Lobster Default = 0.2 = 20%")
                .defineInRange("Lobster chance", 0.4, 0.0, 1.0);

        MANTARAY_CHANCE = BUILDER.comment("The chance of fishing up a Mantaray Default = 0.2 = 20%")
                .defineInRange("Mantaray chance", 0.1, 0.0, 1.0);

        MONKFISH_CHANCE = BUILDER.comment("The chance of fishing up a Monkfish Default = 0.2 = 20%")
        ...
        SHRIMPS_CHANCE = BUILDER.comment("The chance of fishing up Shrimps Default = 0.2 = 20%")
                .defineInRange("Shrimps chance", 0.5, 0.0, 1.0);

        SLIMYEEL_CHANCE = BUILDER.comment("The chance of fishing up an Slimy Eel Default = 0.2 = 20%")
                .defineInRange("Slimy Eel chance", 0.4, 0.0, 1.0);

        SWORDFISH_CHANCE = BUILDER.comment("The chance of fishing up an Swordfish Default = 0.2 = 20%")
