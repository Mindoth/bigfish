...
public class BigFishCommonConfig {
    ...
    static {
        ...
        SPECIAL_FISH_CHANCE = BUILDER.comment("The chance of fishing up a fish from this mod instead of another fish. Default = 0.5 = 50%")
                .defineInRange("Chance", 0.5, 0.0, 1.0);
